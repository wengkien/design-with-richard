...
Design With Richard is a personal content platform and admin hub for Richard Lim to create, publish and manage his Life Architect educational content, frameworks, and audience enquiries — all on a domain he fully owns.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "176506614+wengkien@users.noreply.github.com"
  git config user.name "wengkien"
  ```
